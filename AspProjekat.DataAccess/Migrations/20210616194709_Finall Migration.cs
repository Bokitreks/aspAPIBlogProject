    ...
    public partial class FinallMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 6, 16, 21, 47, 8, 703, DateTimeKind.Local).AddTicks(7715), null, true, false, null, "Life" },
                    { 2, new DateTime(2021, 6, 16, 21, 47, 8, 705, DateTimeKind.Local).AddTicks(7328), null, true, false, null, "Pet" },
                    { 3, new DateTime(2021, 6, 16, 21, 47, 8, 705, DateTimeKind.Local).AddTicks(7367), null, true, false, null, "Sport" },
                    { 4, new DateTime(2021, 6, 16, 21, 47, 8, 705, DateTimeKind.Local).AddTicks(7373), null, true, false, null, "Music" },
                    { 5, new DateTime(2021, 6, 16, 21, 47, 8, 705, DateTimeKind.Local).AddTicks(7377), null, true, false, null, "Movie" }
                });
